						...
						<div class="row">
							<div class="col-12 col-sm-12 col-md-6 col-lg-6">
								<div class="wt-footerlogohold">
									<strong class="wt-logo"><a href="index.php"><img src="assets/img/flogo.png" alt="company logo here"></a></strong>
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<p class="wt-copyrights">Copyright &copy; <?php echo date('Y') ?>
								<nav class="wt-addnav">
									<ul>
										<li><a href="#"> ECOPRINT</a></li>
									</ul>
								</nav>
							</div>
						</div>
